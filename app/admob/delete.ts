...
let admob = require("./admob-common");
...
admob._md5 = function(input) {
    try {
        ...
        let s = new java.lang.String(input);
...
admob._buildAdRequest = function(settings) {
    let builder = new com.google.android.gms.ads.AdRequest.Builder();
    if (settings.testing) {
        ...
        let ANDROID_ID = android.provider.Settings.Secure.getString(admob._getActivity().getContentResolver(), android.provider.Settings.Secure.ANDROID_ID);
        let deviceId = admob._md5(ANDROID_ID);
        if (deviceId !== null) {
    ...
    let adextras = new com.google.android.gms.ads.mediation.admob.AdMobExtras(bundle);
...
admob.preloadVideoAd = function(arg, rewardCB, reload, afterAdLoaded) {
    return new Promise(function(resolve, reject) {
        try {
            let settings = admob.merge(arg, admob.defaults);
            ...
            let InterstitialAdListener = com.google.android.gms.ads.reward.RewardedVideoAdListener.extend({
                onRewarded(reward) {
            ...
            let ad = admob._buildAdRequest(settings);
    ...
    return new Promise(function(resolve, reject) {
        try {
            ...
            if (admob.adView !== null && admob.adView !== undefined) {
                let parent = admob.adView.getParent();
                if (parent !== null) {
            ...
            let bannerType = admob._getBannerType(settings.size);
            ...
            let relativeLayoutParams = new android.widget.RelativeLayout.LayoutParams(
            ...
            let adViewLayout = new android.widget.RelativeLayout(admob._getActivity());
            adViewLayout.addView(admob.adView, relativeLayoutParams);

            let relativeLayoutParamsOuter = new android.widget.RelativeLayout.LayoutParams(
                android.widget.RelativeLayout.LayoutParams.MATCH_PARENT,
                android.widget.RelativeLayout.LayoutParams.MATCH_PARENT);
    ...
    return new Promise(function(resolve, reject) {
        try {
            if (admob.adView != null) {
                let parent = admob && admob.adView && admob.adView.getParent();
                if (parent != null) {
                    parent.removeView(admob.adView);
                }
                admob.adView = null;
...
admob.preloadInterstitial = function(arg) {
    return new Promise(function(resolve, reject) {
        try {
            ...
            // Interstitial ads must be loaded before they can be shown, so adding a listener
            let InterstitialAdListener = com.google.android.gms.ads.AdListener.extend({
                onAdLoaded() {
